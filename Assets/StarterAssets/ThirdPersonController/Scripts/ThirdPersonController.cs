...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        public void Move(NetworkRunner runner, bool sprint, Vector2 move)
        {
                ...
                currentHorizontalSpeed > targetSpeed + speedOffset)
            {
                ...
                _speed = Mathf.Clamp(_speed, 0.0f, targetSpeed);
            }
            else
            {
                _speed = targetSpeed;
        ...
        public void JumpAndGravity(NetworkRunner runner)
        {
            if (Grounded)
            {
